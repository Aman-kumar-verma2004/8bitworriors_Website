...
import { FaLinkedin } from "react-icons/fa6";
 ...
 const TeamMember = ({ name, role, image, socialLinks = {} }) => {
    return (
        <div className="relative w-[250px] h-[320px] sm:w-[250px] sm:h-[330px] md:w-[260px] md:h-[350px] m-5 overflow-hidden rounded-2xl shadow-lg bg-[#43346d99] flex justify-center items-center group">
